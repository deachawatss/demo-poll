...
| UAT-004 | REQ-DEMOPOLL-004 | **Given** a poll API and WebSocket server are available · **When** a visitor submits a choice or another visitor votes · **Then** the results view shows the persisted vote state and animated updated counts and percentages. | ⬜ | Real integration verification pending. |
